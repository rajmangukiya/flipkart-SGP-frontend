      ...
      <div className="background">
        <div className="container">
          ...
          <form action="" className="form">
            ...
            <input type="email" name="email" placeholder="example@gmail.com" className="input" value={formData?.email} onChange={(e) => handleFormChange(e, "email")} />
            <input type="tel" name="mobile" placeholder="123456789" className="input" value={formData?.mobile} onChange={(e) => handleFormChange(e, "mobile")} />
            <input type="password" name="password" placeholder="new password" className="input" value={formData?.password} onChange={(e) => handleFormChange(e, "password")} />
            <input type="password" name="confirm_password" placeholder="confirm password" className="input" value={confirmPwd} />
